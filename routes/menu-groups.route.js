...
router.post('/', menu_groups_controllers.uploadImg, menu_groups_controllers.create);
router.put('/:id', menu_groups_controllers.uploadImg, menu_groups_controllers.update);
